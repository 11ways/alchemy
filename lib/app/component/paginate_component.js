 ...
 * @version       0.3.0
 */
var Paginate = Function.inherits('Alchemy.Component', function PaginateComponent(controller, options) {
	Component.call(this, controller, options);
});
...
Paginate.setMethod(function find(model, options, callback) {
	...
	let filter = conduit.param('filter');
