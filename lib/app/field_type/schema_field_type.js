 ...
 * @version  0.3.0
 */
var SchemaFieldType = FieldType.extend(function SchemaFieldType(schema, name, options) {
 ...
 * @version  1.1.0
 */
SchemaFieldType.setDatatype('object');
 ...
 * @return   {Schema}
 */
SchemaFieldType.setMethod(function getSubschema(record, some_path) {
