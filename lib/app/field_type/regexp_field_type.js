 ...
 * @version  0.3.0
 */
var RegExpFieldType = FieldType.extend(function RegExpFieldType(schema, name, options) {
 ...
 * @version  1.1.0
 */
RegExpFieldType.setDatatype('regexp');
 ...
 * @version  1.1.0
 */
RegExpFieldType.setSelfContained(true);
