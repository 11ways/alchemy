...
Remote.setMethod(function update(context) {
	...
	// A copy: forcing `create` onto the shared save-options object would
	// leak update semantics into the caller's next save
	options = Object.assign({}, options, {create: false});
