 ...
 */
var Router = Function.inherits('Alchemy.Helper', function Router(view) {
	Router.super.call(this, view);
});
...
Router.setMethod(function routeUrl(name, _parameters, options) {
	...
	console.log('Creating route config "' + name + '"');
	console.log(' -- Got config', config, JSON.clone(parameters));
