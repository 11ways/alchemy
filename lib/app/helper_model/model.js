...
Model.setMethod(function addAssociatedDataToRecord(options, query, item, callback) {
	...
	Function.parallel(alchemy.settings.model_assoc_parallel_limit || 4, aliases, function gotAssociatedList(err, list) {
 ...
 * @param    {Function}  callback
 */
Model.decorateMethod(Blast.Decorators.memoize({max_age: 10000, ignore_callbacks: true, static: true}), async function readDatasource(conditions, options, callback) {
	...
	return this.doServerCommand('readDatasource', data, callback);
}, false);
...
Model.setMethod(async function saveRecord(data, options, callback) {
	...
	return this.doServerCommand('saveRecord', data, callback);
