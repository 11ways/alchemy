...
global.Alchemy = Function.inherits('Informer', function Alchemy() {
	...
	if (!Blast.isNW && process.stdout.isTTY && !process.env.DISABLE_JANEWAY && process.argv.indexOf('--disable-janeway') == -1 && this.settings.janeway !== false) {
...
Alchemy.setMethod(function use(module_name, register_as, options) {
	...
	if (register_as) this.modules[register_as] = module;
