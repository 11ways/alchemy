 ...
 */
Alchemy.setMethod(function use(moduleName, registerAs, options) {
	...
	if (moduleName == null && registerAs) {
		alchemy.modules[registerAs] = null;
		return null;
	}

	// If the module has explicitly been set to null, return that
	if (alchemy.modules[moduleName] === null) {
		return null;
	}
