...
Alchemy.setMethod(function usePath(dirPath, options) {
	...
	if (options.modular && options._level == 0) {
		...
		modularRegex.push(/^view$|^helper$|^helper_datasource$|^helper_document$|^helper_model$|^helper_controller$|^helper_component$|^helper_validator$|^element$|^plugins$|^assets$/);
