...
Alchemy.setMethod(function getMimetype(filepath, callback) {
	alchemy.distinctProblem('deprecated-getMimetype', 'alchemy.getMimetype() is deprecated, use Classes.Alchemy.Inode.File.getMimetype()');
...
Alchemy.setMethod(function getFileInfo(filePath, options, callback) {
	...
	tasks.mimetype = function getMimetype(next) {
		Classes.Alchemy.Inode.File.getMimetype(filePath).done(next);
	};
...
Alchemy.setMethod(function downloadFile(url, options, callback) {
	alchemy.distinctProblem('deprecated-downloadFile', 'alchemy.downloadFile() is deprecated, use alchemy.download()');
...
Alchemy.setMethod(function List() {
	alchemy.distinctProblem('deprecated-List', 'alchemy.List() is deprecated');
