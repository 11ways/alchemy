 ...
 * @version  0.3.0
 */
alchemy.hawkejs.load(libpath.resolve(PATH_CORE, 'core', 'base.js'), {server: false, make_commonjs: true});
 ...
 * @version  1.0.0
 */
alchemy.hawkejs.load(libpath.resolve(PATH_CORE, 'core', 'client_base.js'), {server: false, make_commonjs: true});
 ...
 * @version  1.0.5
 */
alchemy.hawkejs.load(libpath.resolve(PATH_CORE, 'core', 'client_alchemy.js'), {make_commonjs: true});
 ...
 * @version  1.0.0
 */
alchemy.hawkejs.load(libpath.resolve(PATH_CORE, 'class', 'path_definition.js'), {server: false, make_commonjs: true});
 ...
 * @version  1.0.0
 */
alchemy.hawkejs.load(libpath.resolve(PATH_CORE, 'class', 'element.js'), {server: false, make_commonjs: true});
 ...
 * @version  1.0.0
 */
alchemy.hawkejs.load(libpath.resolve(PATH_CORE, 'class', 'helper.js'), {server: false, make_commonjs: true});
 ...
 * @version  1.1.0
 */
alchemy.hawkejs.load(libpath.resolve(PATH_CORE, 'class', 'datasource.js'), {server: false, make_commonjs: true});
 ...
 * @version  1.1.0
 */
alchemy.hawkejs.load(libpath.resolve(PATH_CORE, 'class', 'field.js'), {server: false, make_commonjs: true});
 ...
 * @version  1.1.0
 */
alchemy.hawkejs.load(libpath.resolve(PATH_CORE, 'class', 'schema_client.js'), {server: false, make_commonjs: true});
