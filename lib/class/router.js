 ...
 *
 * @param    {string}            name        The name of the path (timestamp)
 * @param    {string}            eventname   The message type (name)
 * @param    {Function|string}   fnc         Function or controller#action string to handle route
 * @param    {Object}            options     Optional options object
 * @param    {string}            options.permission   Permission required to use this linkup
 */
RouterClass.setMethod(function linkup(name, eventname, fnc, options) {

	this.linkupRoutes[eventname] = {
		name       : name,
		fnc        : fnc,
