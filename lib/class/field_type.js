 ...
 * @return   {Mixed}
 */
FieldType.setMethod(function toDatasource(value, data, datasource) {

	if (value == null) {
		return value;
	}

	return this._toDatasource(value, data, datasource);
});
 ...
 * @return   {Mixed}
 */
FieldType.setMethod(function _toDatasource(value, data, datasource) {
