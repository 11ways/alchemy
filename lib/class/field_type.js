 ...
 */
global.FieldType = Function.inherits('Alchemy.Base', function FieldType(schema, name, options) {
 ...
 */
FieldType.makeAbstractClass();

/**
 * This class starts a new group
 */
FieldType.startNewGroup();
 ...
 * @param    {String}
 */
FieldType.setStatic(function setDatatype(type) {
 ...
 * @param    {Boolean}   value
 */
FieldType.setStatic(function setSelfContained(value) {

	if (value == null) {
		throw new Error('FieldType#setSelfContained(value) requires a boolean argument');
	}
 ...
 * @type     {Boolean}
 */
FieldType.setProperty(function is_private() {
 ...
 * @type     {Datasource}
 */
FieldType.setProperty(function datasource() {
 ...
 * @version  0.2.3
 */
FieldType.constitute(function setTitle() {

	var title = this.name.before('FieldType'),
	    type;
 ...
 * @return   {Mixed}
 */
FieldType.setProperty(function title() {
 ...
 * @return   {Mixed}
 */
FieldType.setMethod(function get(property_name) {
 ...
 * @return   {String}
 */
FieldType.setMethod(function getPath(with_top_schema) {
 ...
 * @return   {Mixed}
 */
FieldType.setMethod(function getRecordValue(record, path_to_value_hint) {
 ...
 * @return   {Mixed}
 */
FieldType.setMethod(function cast(value, to_datasource) {
	return value;
});
 ...
 * @return   {Mixed}
 */
FieldType.setMethod(function castForQuery(value, field_paths) {
 ...
 * @return   {Mixed}
 */
FieldType.setMethod(function castCondition(value, field_paths) {
 ...
 * @return   {Mixed}
 */
FieldType.setMethod(function _castCondition(value, field_paths) {
 ...
 */
FieldType.setMethod(function toApp(query, options, value, callback) {
 ...
 * @param    {Object}   values
 */
FieldType.setMethod(function fromRegularToApp(query, options, value, callback) {
 ...
 * @param    {Object}   values
 */
FieldType.setMethod(function fromTranslatableToApp(query, options, value, callback) {
 ...
 * @param    {Function} callback
 */
FieldType.setMethod(function _toApp(query, options, value, callback) {
