...
/**
 * Get the client-side document representation
 *
 * @author   Jelle De Loecker   <jelle@elevenways.be>
 * @since    1.1.5
 * @version  1.1.5
 ...
 * @type     {ClientDocument}
 */
Schema.setProperty(function ClientDocument() {

	if (this.model_class) {
		return this.model_class.ClientDocument;
	}
...
Schema.setMethod(function addField(name, type, options) {
	...
	if (typeof field != 'function') {
		...
		if (Blast.isBrowser) {
			...
			field = Blast.Classes.Alchemy.Field.Field.getMember('string');
		} else {
	...
	if (is_new) {
		...
		if (!this.is_private && this.ClientDocument) {
