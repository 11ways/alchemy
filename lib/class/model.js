...
var Model = global.Model = alchemy.classes.BaseClass.extend(function Model (){
	 ...
	 *
	 * @return   {Void}     Does not return anything, directly stores in this.associations
	 */
	...
	this._createSchema = function _createSchema (blueprint) {
		...
		blueprintClone = alchemy.clone(blueprint);
...
BaseClass.prototype.getModel = function getModel(modelName, autoCreate) {
	...
	// If something is implanted in the current instance context,
	// also implement it in this new instance
	if (this.__implantation__) {
		instance = alchemy.implant(instance, this.__implantation__);
	}

	// Return the possibly-implanted instance
	return instance;
};
