 ...
 * @type   {Schema}
 */
Model.prepareStaticProperty('blueprint', function createBlueprint() {
	...
	// Set the schema name
	schema.setName(this.name.beforeLast('Model'));
 ...
 * @param    {Object}   values
 */
Model.setStatic(function addEnumValues(name, values) {
	return this.blueprint.addEnumValues(name, values);
});
 ...
 * @param    {Object}   values
 */
Model.setStatic(function setEnumValues(name, values) {
	return this.blueprint.setEnumValues(name, values);
});

/**
 * Add a belongsTo association to the blueprint schema
 *
 * @author   Jelle De Loecker   <jelle@codedor.be>
 * @since    1.0.0
 * @version  1.0.0
 */
Model.setStatic(function belongsTo(alias, modelName, options) {
	return this.blueprint.belongsTo(alias, modelName, options);
});

/**
 * Add a hasOneParent association to the blueprint schema
 *
 * @author   Jelle De Loecker   <jelle@codedor.be>
 * @since    1.0.0
 * @version  1.0.0
 */
Model.setStatic(function hasOneParent(alias, modelName, options) {
	return this.blueprint.hasOneParent(alias, modelName, options);
});
 ...
 * @version  1.0.0
 */
Model.setStatic(function hasAndBelongsToMany(alias, modelName, options) {
	return this.blueprint.hasAndBelongsToMany(alias, modelName, options);
});

/**
 * Add a hasMany association to the blueprint schema
 *
 * @author   Jelle De Loecker   <jelle@codedor.be>
 * @since    1.0.0
 * @version  1.0.0
 */
Model.setStatic(function hasMany(alias, modelName, options) {
	return this.blueprint.hasMany(alias, modelName, options);
});

/**
 * Add a hasOneChild association to the blueprint schema
 *
 * @author   Jelle De Loecker   <jelle@codedor.be>
 * @since    1.0.0
 * @version  1.0.0
 */
Model.setStatic(function hasOneChild(alias, modelName, options) {
	return this.blueprint.hasOneChild(alias, modelName, options);
});
 ...
 * @version  1.0.0
 */
Model.setStatic(function addIndex(field, options) {
	return this.blueprint.addIndex(field,  options);
});
...
Model.get = function get(name) {
	...
	return new alchemy.classes[name.modelName() + 'Model'];
};
