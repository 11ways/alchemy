...
Document.setProperty(function $model() {
	...
	if (!this.$options.model) {
		this.$options.model = this.getModel(this.modelName);
	}
...
Document.setMethod(function toHawkejs(wm) {
	...
	DocClass = Classes.Hawkejs.Document.getDocumentClass(this.modelName);
...
Document.setMethod(function save(data, options, callback) {
	...
	function updateDoc(err, saveResult) {
		...
		main._id = alchemy.castObjectId(saveResult[that.modelName]._id);
