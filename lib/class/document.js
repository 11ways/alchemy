 ...
 */
var Document = Function.inherits('Iterator', 'Array', 'Informer', function Document(record) {
...
Document.setStatic(function getDocumentClass(model) {
	...
	if (DocClass == null) {
		DocClass = Function.inherits('Document', Function.create(name, function med(data) {
			med.wrapper.super.call(this, data);
		}));
