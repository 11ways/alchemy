...
/**
 * Get the root context (the one without a parent)
 *
 * @author   Jelle De Loecker <jelle@elevenways.be>
 * @since    1.4.0
 * @version  1.4.0
 ...
 * @return   {Alchemy.OperationalContext}
 */
OperationalContext.setMethod(function getRoot() {
...
/**
 * Create a new instance for the given document data
 *
 * @author   Jelle De Loecker <jelle@elevenways.be>
 * @since    1.4.0
 * @version  1.4.0
 ...
 * @return   {OperationalContext}
 */
OperationalContext.setMethod(function withDatasourceEntry(entry) {

	let result = this.createChild();
	result.setRootData(entry);
