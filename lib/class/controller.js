 ...
 */
Controller.setMethod(function renderDialogIn(action, template) {
	...
	this.doAction(action, this.initial_action_arguments);

	this.conduit.viewRender.once('executing', function onceBegin() {
		that.conduit.viewRender.showDialog('salons/review');
	});
});
