 ...
 */
global.Component = Function.inherits('Alchemy.Base', function Component(controller, options) {
...
Component.get = function get(componentName, controller, options) {
	...
	if (Classes.Alchemy[fullName] == null) return false;

	return new Classes.Alchemy[fullName](controller, options);
};