...
var Component = global.Component = alchemy.classes.BaseClass.extend(function Component (){
	 ...
	 * @return   {undefined}
	 */
	this.preInit = function preInit(controller, options) {
...
Component.get = function get(componentName) {
	...
	var returnComponent = new alchemy.classes[fullName]({__passArgs__: args});
 ...
 * @version  0.0.1
 */
BaseClass.prototype.getComponent = function getComponent(componentName) {

	// Get the model instance
	var instance = Component.get(componentName),
	    keys, key, nr;
