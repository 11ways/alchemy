...
Conduit.setMethod(function _postpone(options) {
	...
	// End the response is wanted
	if (end_message !== false) {
		if (!end_message) {
			end_message = 'The response has been postponed, you can find it at <a href="' + url + '">' + url + '</a>';
		}
