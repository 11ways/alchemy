...
Conduit.setMethod(function parseRoute() {
	...
	if (!this.route) {
		...
		this.params = this.route.match(this.sectionPath) || {};
	}
 ...
 * @version  0.2.0
 */
Conduit.setMethod(function render(templateName) {
	...
	this.viewRender.beginRender(templates, {}, function afterRender(err, html) {
		...
		if (typeof html !== 'string') {
			...
			that.response.writeHead(200, {'Content-Type': 'application/json-dry'});
		}
