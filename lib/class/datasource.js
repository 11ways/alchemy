...
Datasource.setMethod(function toDatasource(schema, data) {
	...
	for (fieldName in data) {
		...
		if (field != null) {
			data[fieldName] = this.valueToDatasource(field, data[fieldName], data);
		}
	}
 ...
 * @version  1.0.0
 */
Datasource.setMethod(function valueToDatasource(field, value, data) {

	value = field.toDatasource(value, data, this);

	return this._valueToDatasource(field, value, data);
});
 ...
 * @version  1.0.0
 */
Datasource.setMethod(function _valueToDatasource(field, value, data) {
	return value;
});
