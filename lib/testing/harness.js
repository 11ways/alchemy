...
TestHarness.setMethod(function getPluginPath(plugin_name) {
	...
	// We need to resolve from the project's path_root, not from this module
	let package_json_path = require.resolve(plugin_name + '/package.json', {
		paths: [libpath.resolve(this.options.path_root, 'node_modules')]
	});
